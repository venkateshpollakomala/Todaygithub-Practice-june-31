...
public class askmeOffersHomePage {
            ...
            if (imageUrl != null && !imageUrl.isEmpty()) {
                ...
                try {
                    ...
                    if (responseCode != HttpURLConnection.HTTP_OK) {
                        System.out.println("Broken Image Found - Image Src: " + imageUrl + ", Response Code: " + responseCode);
                    } else {
    ...
    public void verifyBrokenImages() {
        ...
        //Assert.assertEquals(pageTitle, "Your Source for the Latest News, Reviews & Coupon");
